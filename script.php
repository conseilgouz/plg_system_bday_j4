...
class plgsystembdayInstallerScript
{
	...
	private function postinstall_cleanup() {
		...
		$obsloteFiles = [sprintf("%s/plugins/system/%s/css_admin.css", JPATH_SITE, $this->extname),
						 sprintf("%s/plugins/system/%s/css_admin.js", JPATH_SITE, $this->extname)];
		...
		if (($version_arr[0] == "4") || (($version_arr[0] == "3") && ($version_arr[1] == "10"))) {
			...
			$langFiles = [
				sprintf("%s/language/en-GB/en-GB.plg_system_%s.ini", JPATH_ADMINISTRATOR, $this->extname),
				sprintf("%s/language/en-GB/en-GB.plg_system_%s.sys.ini", JPATH_ADMINISTRATOR, $this->extname),
				sprintf("%s/language/fr-FR/fr-FR.plg_system_%s.ini", JPATH_ADMINISTRATOR, $this->extname),
				sprintf("%s/language/fr-FR/fr-FR.plg_system_%s.sys.ini", JPATH_ADMINISTRATOR, $this->extname),
			];
